...
<head>
    ...
    <title>Management Planned details</title>
    <!-- Bootstrap Core CSS -->
...
<a  href ="in-charge.php?action=dashb"><button class = " w3-btn w3-button fa fa-home w3-hover-silver" style="background-color:; border:none; margin-left: ; margin-right: 10%; padding-top: 8px; font-size: 20px; color: white"> Home</button> </a>
        ...
        <div class="page-wrapper" style="margin-left: -25px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: 100%;">
                    <h3 class="text-primary w3-center" >Management Assement Plan Details </h3> </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 10%;"> Assessor Comment</th>
                                <th style="width: 70%;">Date</th>
                                                <th style="width:40%">Management Plan</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                 <th style="width: 10%;">Standard</th>
                                                <th style="width: 50%;">Assessor Comment</th>
                                                <th style="width: 10%;">Date </th>
                                                <th style="width:50%">Management Plan</th>
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM action_plan,standard, department where action_plan.standard_code=standard.standard_code AND standard.department_id=department.department_id AND standard.department_id='$Name'") or die(mysqli_error());
