...
<head>
    ...
    <title>Standard Details at Department</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" style="margin-left: -25px;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: 100%;">
                    <h3 class="text-primary w3-center" >Department Health Standards </h3> </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM `standard`,`criteria` WHERE   standard.standard_code=criteria.standard_code AND standard.department_id='$Name' ") or die(mysqli_error());
