...
<head>
    ...
    <title>Assessment Rules at Department Level</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" style="margin-left: -2%;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: ">
                    <h3 class="text-primary" >Department Assessment Rules </h3> </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered w3-large" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                               <th style="">Standard</th>
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM `assessment_rules` WHERE department='$Name'") or die(mysqli_error());
