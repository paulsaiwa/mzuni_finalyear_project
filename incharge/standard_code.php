...
<a  href ="in-charge.php?action=dashb"><button class = " w3-btn w3-button fa fa-home w3-hover-silver w3-text-white" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; padding-top: 8px; font-size: 20px;"> Home</button> </a>
...
<a  href ="../logout.php" class = "w3-btn w3-bar-item w3-red fa fa-sign-out w3-button w3-right" style="height:35px; padding-top: 8px; font-size: 20px;">Logout</a>
        ...
        <div class="page-wrapper" style="margin-left: -2%;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: ">
                    <h3 class="text-primary" >Health Standard </h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title w3-center">General Health Standard(s)</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width:40%; ">Verification Criteria</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                 <th style="width:;">Standard</th>
                                                <th style="">Description</th>
                                                <th style="width: ;">Criteria#</th>
                                                <th style="width:%">Verification Criteria</th>
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM `standard`,`criteria`,`department` WHERE   standard.standard_code=criteria.standard_code AND standard.department_id=department.department_id") or die(mysqli_error());
