                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 10%;">Implementation Start Date </th>
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM budget,standard, department where budget.standard_code=standard.standard_code AND standard.department_id=department.department_id AND standard.department_id='$Name'") or die(mysqli_error());
