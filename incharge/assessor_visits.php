...
<a  href ="in-charge.php?action=dashb"><button class = " w3-btn w3-button fa fa-home w3-hover-silver" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; padding-top: 8px; font-size: 20px; color: white;"> Home</button> </a>
...
<a  href ="../logout.php" class = "w3-btn w3-bar-item w3-red fa fa-sign-out w3-button w3-right" style="height:35px; padding-top: 8px; font-size: 20px;">Logout</a>
        ...
        <div class="page-wrapper" style="margin-left: -2%;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: 100%;">
                    <h3 class="text-primary w3-center" >Department Assessor(s) Sessions </h3> </div>
      ...
      $result=mysqli_query($connection,"select * from user,department where user.user_id='$user_id'")or die(mysqli_error());
...
?>
            ...
            <div class="container-fluid">
             ...
             $s_query = $conn->query("SELECT * FROM `facilitator_monitors`, `user` where facilitator_monitors.user_id=user.user_id AND user.department_id='$Name'") or die(mysqli_error());
                 ...
                 <footer class="foote" id="" style="margin-top: -8%;">
