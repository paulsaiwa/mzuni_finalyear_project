...
<div class = "alert alert-info w3-center w3-xlarge w3-text-black" style="margin-top: 3%;">Criteria details</div>
						...
						<table id = "table2" class = "table table-bordered" style="width: ">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo "<a href='editcriteria.php?c_id=".$s_fetch['c_id']."' class='w3-button w3-khaki w3-hover-green fa fa-pencil w3-xlarge' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
									<td><?php echo "<a href='deletecriteria.php?c_id=".$s_fetch['c_id']."' class='w3-button w3-red w3-hover-green fa fa-remove w3-xlarge' style='width:100%; border-radius:4px;'>Delete</a>";?> 
									</td>
