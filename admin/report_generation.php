            ...
            <div class="cc" id="cont_<?="$department_id";?>" style="display: none;">
                <div class="w3-row">
                    ...
                    <div class="w3-col m6 w3-padding">
                        <button class="btn bt btn-success btn-sm" data="details_<?="$department_id";?>">Facilitator Assessor Captured details</button>
                ...
                <div class="cct" id="details_<?="$department_id";?>" style="display: none;">
                  ...
                  $s_query = $conn->query("SELECT * FROM log") or die(mysqli_error());
