...
<a  href ="home.php?action=facility" class = " w3-btn w3-button fa fa-building" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; color: white; font-size: 20px;"> Register facility</a>
...
<div class = "alert alert-info w3-center" style="margin-top: 3%;">Facility  details</div>
            ...
            <table id = "table2" class = "table table-bordered" style="width: 90%;">
              ...
              <tbody>
                <?php
                  ...
                  $s_query = $conn->query("SELECT * FROM `facility`") or die(mysqli_error());
                  while($s_fetch = $s_query->fetch_array()){  
                ?>
                <tr>
                  <td><?php echo $s_fetch['name']?></td>
                  <td><?php echo $s_fetch['type']?></td>
                  <td><?php echo $s_fetch['address']?></td>
                  <td><?php echo $s_fetch['email']?></td>
                  <td><?php echo $s_fetch['contact']?></td>
                 
                  <td> <?php echo '<a href="editfacility.php?facility_id='.$s_fetch['facility_id'].
                        '" class="w3-button w3-center w3-khaki fa fa-edit w3-xlarge" style="height:30px;">Update</a> </td>';?>

                  <td><?php echo '<a href="deletefacility.php?facility_id='.$s_fetch['facility_id'].
                         '" class="w3-center w3-bar-item w3-button fa fa-remove w3-red w3-xlarge" >Delete</a> </td>';?>
