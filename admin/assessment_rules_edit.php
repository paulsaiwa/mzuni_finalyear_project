...
<div class = "alert alert-info w3-center w3-xlarge w3-text-black" style="margin-top: 3%;">Assessment Rules details Modification</div>
    <div id = "s_table" class = "panel panel-default">
          <div  class = " panel-heading"> 
            <table id = "table2" class = "table table-bordered" style="width:;">
              ...
              <tbody>
                <?php
                  ...
                  $s_query = $conn->query("SELECT * FROM `department`,`assessment_rules` WHERE department.department_id=assessment_rules.department") or die(mysqli_error());
                ...
                <tr>
                  ...
                  <td><?php echo "<a href='rules_edit.php?standard_code=".$s_fetch['standard_code']."' class='w3-button w3-green w3-hover-teal w3-xlarge fa fa-edit' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
                  <td><?php echo "<a href='deleterules.php?standard_code=".$s_fetch['standard_code']."' class='w3-button w3-red w3-xlarge w3-hover-green fa fa-remove' style='width:100%; border-radius:4px;'>Delete</a>";?> 
                  </td>
