...
<a  href ="../logout.php" class = "w3-btn w3-bar-item w3-red fa fa-sign-out w3-button w3-right" style="height:35px; padding-top: 8px; font-size: 20px;">Logout</a>
		...
		<div class="w3-col ">
			...
			<div class="w3-container">
				 <h2 class="" style="margin-left: 30%; color: ">Department plan, Budget management(update and Remove)</h2>
<div class="w3-container w3-left-align" style="width: ; margin-left: ;">
  	<?php
  		...
  		while ($data = $sql->fetch_assoc()) {
  			...
  			<div class="cc" id="cont_<?="$department_id";?>" style="display: none;">
  				...
  				<div class="cct" id="details_<?="$department_id";?>" style="display: none;">
  					...
  					<table id="example_<?="$department_id";?>" class=" w3-table w3-table-all table-bordered" cellspacing="0" width="%;">
                                        <thead>
                                            <tr>
                ...
                <tr>
                  ...
                  <td><?php echo "<a href='edit_plan.php?action_id=".$s_fetch['action_id']."' class='w3-button w3-khaki w3-hover-green fa fa-pencil w3-large' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
                  <td><?php echo "<a href='deleteplan.php?action_id=".$s_fetch['action_id']."' class='w3-button w3-red w3-hover-green fa fa-remove w3-large' style='width:100%; border-radius:4px;'>Delete</a> ";?></td>
          ...
          <div  class = " panel-heading"> 
            <table id = "example2_<?="$department_id";?>" class = "w3-table-all w3-table table-bordered " cellpadding='0' width="100%">
              <thead style="">
                <tr>
                  <th>Standard Code</th>
                  <th>Budget</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $s_fetch['endDate']?></td>
                   <td><?php echo "<a href='editcriteria.php?c_id=".$s_fetch['budget_id']."' class='w3-button w3-khaki w3-hover-green fa fa-pencil w3-xlarge' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
                  <td><?php echo "<a href='editcriteria.php?c_id=".$s_fetch['budget_id']."' class='w3-button w3-red w3-hover-green fa fa-remove w3-large' style='width:100%; border-radius:4px;'>Delete</a> ";?></td>
                ...
                ?>
 					...
 					<div class="cct" id="standard_<?="$department_id";?>" style="display: none;">
  					...
  					<table id="example1_<?="$department_id";?>" class=" w3-table w3-table-all table-bordered" cellspacing="0" width="100%;">
                                        <thead>
                                            <tr>
  				...
  				<div class="cct" id="budget_<?="$department_id";?>" style="display: none;">
  					...
  					<table id="example3_<?="$department_id";?>" class=" w3-table w3-table-all table-bordered" cellspacing="0" width="100%;">
              <thead style="">
                <tr>
                  <th>Standard Code</th>
