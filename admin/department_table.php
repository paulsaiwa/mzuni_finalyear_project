...
<a  href ="home.php?action=department" class = " w3-btn w3-button fa fa-building" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; font-size: 20px; color: white;"> Register Department</a>
...
<div class = "alert alert-info w3-center w3-xlarge w3-text-black" style="margin-top: 3%;">Department  details</div>
    <div id = "s_table" class = "panel panel-default">
          <div  class = " panel-heading"> 
            <table id = "table2" class = "table table-bordered w3-large" style="width: ;">
              ...
              <tbody>
                <?php
                  ...
                  $s_query = $conn->query("SELECT * FROM `department`  ORDER by department_id") or die(mysqli_error());
                ...
                <tr>
                  ...
                  <td><?php echo "<a href='editdepartment.php?department_id=".$s_fetch['department_id']."' class='w3-button w3-khaki w3-hover-green fa fa-edit w3-xlarge' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
                  <td><?php echo "<a href='deletedepartment.php?department_id=".$s_fetch['department_id']."' class='w3-button w3-red w3-hover-green fa fa-remove w3-xlarge' style='width:100%; border-radius:4px;'>Delete</a>";?> 
                  </td>
