...
<div class="w3-bar w3-sand" style="margin-top: -23px;">
  ...
  <a href="../logout.php" class="w3-bar-item w3-button w3-red"style="margin-left: 50%; margin-right: ;">Logout</a>
</div>
...
?>
	...
	<?php 
 $id=$_REQUEST['id'];
$sel=mysql_query("SELECT * FROM assessment_details WHERE id='$id'");

$fetch=mysql_fetch_array($sel);


?>	
<a class="w3-button w3-left w3-hover-green w3-light-blue"  href="standard_table.php" style="margin-right: 10%;" >Back </a>		
  ...
  <tr>
	...
	<tr>
    <td>Name</td>
    <td><input type="text" name="do" class="form-control" value="<?php echo $fetch['do'] ?>" /></td>
  </tr>
  <tr><td></td><td>
...
$backup=mysql_query("INSERT INTO plan VALUES('','$dcode','$dname')");
if(!$backup){
echo "<label class='w3-center' style='color:red'>plan details not tstored<label>";

}else {
  echo "<label class='w3-center' style='color:green'>plan details stored successfully<label>";
