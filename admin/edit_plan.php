...
<div class="w3-row w3-grey" style="margin-top: -1px ; font-size: 17px; border-top-color: red; border-top-style:solid ; border-bottom-style:solid ; border-bottom-color: red;">
...
<a href="standard_table.php" class="w3-button w3-light-blue w3-bar-item w3-hover-green fa fa-arrow-left" style="margin-top: 6%; margin-bottom: -6%">Back</a>	
      ...
      <h3 class="alert alert-info w3-center" style="width: 80%">Modify Management Plan</h3>
	<table class="w3-center" style="margin-left: -30%;">
  
	<tr>
    <td>Plan</td>
    <td><textarea name="plan" class="form-control"><?php echo $fetch['plan']?></textarea></td>
  </tr>
