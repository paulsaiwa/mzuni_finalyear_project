...
<a  href ="home.php?action=dash"><button class = " w3-btn w3-button fa fa-home w3-hover-silver" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; padding-top: 8px; font-size: 20px; color: white;"> Home</button> </a>
