  			...
  			<div class="cc" id="cont_<?="$department_id";?>" style="display: none;">
  				<div class="w3-row">
	  				...
	  				<div class="w3-col m6 w3-padding">
	  					<button class="btn bt btn-success btn-sm" data="details_<?="$department_id";?>">Assessment session details</button>
	  					<button class="btn bt btn-warning btn-sm" data="plan_<?="$department_id";?>">Manage Plan</button>
	  					<button class="btn bt btn-success btn-sm" data="standard_<?="$department_id";?>">Standards</button>
	  					
	  				</div>
  				</div>
  				<div class="cct" id="details_<?="$department_id";?>" style="display: none;">
  					<h3>Assessment Session Details</h3>
  					<table id="example_<?="$department_id";?>" class=" w3-table w3-table-all table-bordered" cellspacing="0" width="100%;">
                                        <thead>
                                            <tr>
                  ...
                  $s_query = $conn->query("SELECT * FROM `assessment_details` ,`standard` WHERE assessment_details.standard_code=standard.standard_code AND standard.department_id='$department_id'") or die(mysqli_error());
                ...
                ?>
  				...
  				<div class="cct" id="plan_<?="$department_id";?>" style="display: none;">
  					<h4> Planners and Decision Makers Assessment Committee</h4>
            ...
            <table id = "example2_<?="$department_id";?>" class = "w3-table-all w3-table table-bordered " cellpadding='0' width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $s_fetch['comment']?></td>
                  <td><?php echo $s_fetch['year']?></td>
                  <td><?php echo "<a onclick=\"open_standards('".$s_fetch['id']."')\" class='btn btn-success fa fa-edit'>Plan</a> ";?></td>
