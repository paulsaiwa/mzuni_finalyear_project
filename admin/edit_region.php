...
$sel=mysqli_query($connection,"SELECT * FROM regions WHERE region_id='$id'");
...
<a href="location_manage_table.php" class="w3-button w3-light-blue w3-bar-item w3-hover-green fa fa-arrow-left" style="margin-top: 6%; margin-bottom: -6%">Back</a>	
      ...
      <h3 class="alert alert-info w3-center" style="width: 80%">Modify Region details</h3>
	<table class="w3-center" style="margin-left: -30%;">
  <tr>
    
    <td><input type="Hidden" name="region_id" class="form-control" readonly="readonly" value="<?php echo $fetch[0] ?>"   /></td>
	</tr>
	<tr>
    <td>Region Name</td>
    <td><input type="text" name="region_name" class="form-control"value="<?php echo $fetch[1] ?>" /></td>
  </tr>
...
// get the posted data
$dcode = $_REQUEST['region_id'];
$dname= $_REQUEST['region_name'];
...
*/
$update=mysqli_query($connection,"UPDATE regions SET region_id='$dcode',region_name='$dname'  WHERE region_id='$dcode' ");
if($update){
echo '<font color="green"> Region successully updated...</font> ';
