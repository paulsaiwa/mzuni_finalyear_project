...
$sel=mysqli_query($connection,"SELECT * FROM districts WHERE district_id='$id'");

$fetch=mysqli_fetch_array($sel);


?>		
<a href="location_manage_table.php" class="w3-button w3-light-blue w3-bar-item w3-hover-green fa fa-arrow-left" style="margin-top: 6%; margin-bottom: -6%">Back</a>	
		
		<center>
		<form method="post" style="">
      <h3 class="alert alert-info w3-center" style="width: 80%">Modify District details</h3>
	<table class="w3-center" style="margin-left: -30%;">
  <tr>
    
    <td><input type="Hidden" name="district_id" class="form-control" readonly="readonly" value="<?php echo $fetch[0] ?>"   /></td>
	</tr>
	<tr>
    <td>District Name</td>
    <td><input type="text" name="district_name" class="form-control"value="<?php echo $fetch[1] ?>" /></td>
  </tr>
  <tr>
    <td>Region</td>
    <td><select name="region_id" class="form-control" style="width:250%" required >
     <?php
...
// get the posted data
$dcode = $_REQUEST['district_id'];
$dname= $_REQUEST['district_name'];
$darea= $_REQUEST['region_id'];
...
*/
$update=mysqli_query($connection,"UPDATE districts SET district_id='$dcode',district_name='$dname',
 region_id='$darea'  WHERE district_id='$dcode' ");
if($update){
echo '<font color="green"> District successully updated...</font> ';
