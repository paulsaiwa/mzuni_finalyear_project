...
<?php include "user_header.php";?>
		...
		<div class="w3-col ">
<div class = "alert alert-info w3-center w3-xlarge w3-text-black " style="margin-top:3%;">user profile</div>
						...
						<table id = "table" class = "table table-bordered" style="">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo "<a href='useredit.php?user_id=".$s_fetch['user_id']."' class='w3-button w3-khaki w3-hover-green fa fa-pencil w3-large' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
