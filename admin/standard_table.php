...
<div class="w3-row w3-sand w3-large w3-hover-white" style="margin-top: -10px">
<a  href ="home.php?action=dash"><button  class = "w3-btn w3-button fa fa-home" style="background-color:; border:none; margin-left: 3%; margin-right: 3%;">Home</button> </a>

<div class="dropdown" style="margin-left:; margin-right:3%;">
  <button  class="w3-btn w3-button fa fa-stethoscope" style=""><span >Manage Assessment</span></button>
  <div class="dropdown-content">
       <button class="w3-btn w3-red w3-block" id="uview" >assessment</button>
        <button class="w3-btn w3-red w3-block" id="plan" >Planning</button>
...
<div class="dropdown" style="margin-left:; margin-right:3%;">
  <button  class="w3-btn w3-button fa fa-institution" style=""><span >Facility</span></button>
  <div class="dropdown-content ">
...
<div class="dropdown" style="margin-left:; margin-right:3%;">
  ...
  <div class="dropdown-content">
    ...
    <a class="w3-btn w3-light-grey w3-block "   href="home.php?action=district">Add</a>
...
<a  href ="../logout.php"><button class = "w3-red w3-button fa fa-sign-out w3-right" style="background-color:red; border:none; margin-left: 4%;">Logout</button> </a>

		</div>
		
		<div class="w3-col ">

			<div class="w3-padding cs" id="View" style="margin-top: 6%;">
...
<div class = "alert alert-info w3-center">Criteria details</div>
		<div id = "s_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table2" class = "table table-bordered" style="">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $s_fetch['number']?></td>
									<td><?php echo $s_fetch['criteria']?></td>
									<td><?php echo "<a href='editcriteria.php?c_id=".$s_fetch['c_id']."' class='w3-button w3-khaki w3-hover-green fa fa-pencil' style='width:100%; border-radius:4px;'>Update</a> ";?></td>
									<td><?php echo "<a href='deletecriteria.php?c_id=".$s_fetch['c_id']."' class='w3-button w3-red w3-hover-green fa fa-remove' style='width:100%; border-radius:4px;'>Delete</a>";?> 
									</td>
...
<div class = "alert alert-info w3-center">Assessment(s) details</div>
	

          
		 <div id = "s_table" class = "panel panel-default">
		<div  class = " panel-heading">	
		<table id = "table21" class = "w3-table table-bordered" >
			<thead><tr>
				<th>Std Code</th><th>Date</th><th>Criteria</th><th>Observation</th><th>Comment</th><th>Action</th>
			</tr></thead>
			<tbody>
			<?php
			include 'connection.php';
			...
			while ($ro = $sql->fetch_assoc()) {
				...
				while ($row = $in->fetch_assoc()) {
					...
					if ($i > 1) {
						...
						echo "<tr><td rowspan=\"$count\">{$row['standard_code']}</td><td>{$row['date']}</td><td>{$row['do']}</td><td>{$row['level_achieved']}</td><td>{$row['comment']}<td><button class='w3-hover-pink w3-green fa fa-commenting' style='width:100%; border:none;' onclick=\"showModal('$std');\">Plan</button></td></td>";
...
<div class="w3-padding cs" id="Planning" style="display: none;">
		
<div class = "alert alert-info w3-center">Hospital Management Assessment plan(s) details</div>
	

<div id = "s_table" class = "panel panel-default">
					<div  class = " panel-heading">	
						<table id = "table10" class = "table table-bordered" style="">
							<thead style="background-color: khaki;">
								<tr>
									<th>Standard(ID)</th>
