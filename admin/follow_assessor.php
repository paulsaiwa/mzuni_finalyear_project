...
<a  href ="../logout.php" class = "w3-btn w3-bar-item w3-red fa fa-sign-out w3-button w3-right" style="height:35px; padding-top: 8px; font-size: 20px;">Logout</a>
		...
		<div class="w3-col ">
			...
			<div class="w3-container">
				 <h2 class="" style="margin-left: 30%; color: ">Department Assessor Follow up Details</h2>
  			...
  			<div class="cc" id="cont_<?="$department_id";?>" style="display: none;">
  				<div class="w3-row">
	  				...
	  				<div class="w3-col m6 w3-padding">
	  					<button class="btn bt btn-success btn-sm" data="details_<?="$department_id";?>">Assessor Follow Up details</button>
  				...
  				<div class="cct" id="details_<?="$department_id";?>" style="display: none;">
  					<h3>Assessor Follows Details</h3>
  					<table id="example23" class=" w3-table w3-table-all table-bordered" cellspacing="0" width="100%;">
                                        <thead>
                                            <tr>
                                                
												<th style="width:50%;"> Standard Code</th>
												<th style="width:30%;" >Recommendation(Assessor)</th>
												<th style="width:50%;">Management Feedback</th>
												<th>Follow upn Comment</th>
                        <th>Date Made</th>
                  ...
                  $s_query = $conn->query("SELECT * FROM `assessor_followups` ,`standard` WHERE assessor_followups.standard_code=standard.standard_code AND standard.department_id='$department_id'") or die(mysqli_error());
                ...
                <tr>
                  ...
                  <td><?php echo $s_fetch['time_follow']?></td>
