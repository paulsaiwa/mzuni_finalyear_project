...
<head>
    ...
    <title>Facilitators Assessment Session</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="page-wrapper" style="margin-left: -2%;">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: ">
                    <h3 class="text-primary" >Department Assessment Facilitators  </h3> </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM `facilitator_monitors`,`user` WHERE  user.user_id=facilitator_monitors.facilitator") or die(mysqli_error());
