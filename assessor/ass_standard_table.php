...
<div class="w3-row w3-grey" style="margin-top: 6px ; font-size: 17px; border-top-color: red; border-top-style: solid; border-bottom-style: solid; border-bottom-color: red; font-size: 20px; color: white;">
<a  href ="assessor.php?action=dashboard"><button class = " w3-btn w3-button fa fa-home w3-hover-silver" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; padding-top: 8px; font-size: 20px; color: white;"> Home</button> </a>
<a  href =""><button class = " w3-btn w3-button fa fa-refresh w3-hover-silver" style="background-color:; border:none; margin-left: 10%; margin-right: 10%; padding-top: 8px; font-size: 20px; color: white;"> Refresh</button> </a>
        ...
        <div class="page-wrapper" style="margin-left: -2%">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Standard Details</h3> </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">General Standards</h4>
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="width: 10%;">Criteria number</th>
                                                <th style="width: 50%;">Verification Criteria</th>
