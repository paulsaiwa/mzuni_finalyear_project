...
<head>
    ...
    <title>Management budget details</title>
    <!-- Bootstrap Core CSS -->
...
<a  href ="assessor.php?action=dashboard"><button class = " w3-btn w3-button fa fa-home w3-hover-silver" style="background-color:; border:none; margin-left: ; margin-right: 10%; padding-top: 8px; font-size: 20px; color: white"> Home</button> </a>
...
<a  href ="../logout.php" class = "w3-btn w3-bar-item w3-red fa fa-sign-out w3-button w3-right" style="height:35px; padding-top: 8px; font-size: 20px;">Logout</a>
        ...
        <!-- Page wrapper  -->
        <div class="page-wrapper" style="margin-left: -25px;">
            <!-- Bread crumb -->

            <div class="row page-titles">
                <div class="col-md-5 align-self-center" style="width: 100%;">
                    <h3 class="text-primary w3-center" >Management Assessment Budget Details </h3> </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th style="width: 10%;">Standard</th>
                                                 <th style="width: 10%">Budget(Management)</th>
                                                <th style="width: 50%;">Start Implementation Date</th>
                                                <th style="width: 50%;">Implementation Finish Date</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                 <th style="width: 10%;">Standard</th>
                                                 <th style="width: 50%">Budget(Management)</th>
                                                <th style="width: 20%;">Start Implementation Date</th>
                                                <th style="width: 20%;">Implementation Finish Date</th>
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM standard, department, budget where budget.standard_code=standard.standard_code AND standard.department_id=department.department_id  AND standard.department_id='$Name'") or die(mysqli_error());
