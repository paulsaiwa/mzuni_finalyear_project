                        ...
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th style="">Verification Criteria</th>
                                                <th>Area</th>
                                ...
                                include '../connection.php';
                                    ...
                                    $s_query = $conn->query("SELECT * FROM `standard`,`criteria`,`department` WHERE   standard.standard_code=criteria.standard_code AND standard.department_id='$Name' AND department.department_id=standard.department_id") or die(mysqli_error());
